...
-input: string
-output: array of strings with the word count

-problem domain: words are seperated by exactly one spaces, any
substring of non-space characters is a word.

algorithim

split the array up into an array

iterate trhough the array and `+=` word.size to each word
