...
input: string
output: string with every other upcased, if it is not a letter, don't do anything

split the string into an array 
iterate through using map with index, join the array.  if (index + 1).odd? .upcase
=end 
