...
# #  where variables represent category names. Can we do that without
...
# # Based on the examples shown above, write a method that
# # takes an array as an argument. The method should yield 
# # the contents of the array to a block, which should 
# # assign your block variables in such a way that it 
# # ignores the first two elements, and groups all remaining
...
types(birds) do |bird1, bird2, *raptors|
